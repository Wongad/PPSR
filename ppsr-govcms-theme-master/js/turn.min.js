...
return this}})})()
$(window).ready(function(){$('#option2').turn({display:'single',acceleration:!0,autoCenter:!0,gradients:!$.isTouch,elevation:50,duration:1000,elevation:84,gradients:!0,pages:52,when:{turning:function(event,page,view){var book=$(this),currentPage=book.turn('page'),pages=book.turn('pages');Hash.go('page'+page).update()},}});$('.magazine').turn({width:1190,height:842,autoCenter:!0,duration:1000,elevation:84,gradients:!0,pages:52,when:{turning:function(event,page,view){var book=$(this),currentPage=book.turn('page'),pages=book.turn('pages');Hash.go('page'+page).update()},}});Hash.on('^page\([0-9]*)$',{yep:function(path,parts){var page=parts[1];if(page!==undefined){if($('.magazine').turn('is'))
$('.magazine').turn('page',page)
$('#option2').turn('page',page),($('#option2').turn('is'))
$('#option2').turn('page',page)
$('.magazine').turn('page',page)}},nop:function(path){if($('.magazine').turn('is'))
$('.magazine').turn('page',1),($('#option2').turn('is'))
$('#option2').turn('page',1)}})});$(window).bind('keydown',function(e){if(e.keyCode==37)
$('.magazine').turn('previous'),$('#option2').turn('previous');else if(e.keyCode==39)
$('.magazine').turn('next'),$('#option2').turn('next')})
